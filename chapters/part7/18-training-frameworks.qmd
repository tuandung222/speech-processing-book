...
::: {.callout-note title="Chọn Framework nào?"}
...
: So sánh Speech Training Frameworks {#tbl-frameworks-comparison}

## WeNet - Chi tiết {#sec-wenet}
...
: WeNet vs ESPnet {#tbl-wenet-vs-espnet}
...
: k2/icefall features {#tbl-k2-features}
...
::: {.callout-warning title="fairseq maintenance"}
...
: Speech Frameworks vs NLP Frameworks {#tbl-speech-vs-nlp-frameworks}

::: {.callout-note title="Khi nào dùng HF Trainer cho Speech?"}
...
: Framework recommendations {#tbl-framework-recommendations}
