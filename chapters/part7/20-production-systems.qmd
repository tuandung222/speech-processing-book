...
![End-to-End Voice AI Pipeline (target latency < 1s)](fig-20-production-22.png){#fig-voice-ai-pipeline width=70%}
...
![3 Endpointing Strategies](fig-20-production-23.png){#fig-endpointing width=80%}
...
![TensorRT-LLM + Triton Inference Server Pipeline](fig-20-production-24.png){#fig-tensorrt-triton width=70%}
...
![Production Microservice Architecture](fig-20-production-25.png){#fig-microservice-arch width=60%}
