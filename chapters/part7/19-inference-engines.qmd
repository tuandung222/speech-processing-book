...
::: {.callout-note title="Tại sao cần Inference Engine riêng?"}
...
: So sánh Inference Engines cho Speech {#tbl-inference-engines}
...
: TensorRT speedup trên A100 GPU (batch=1, 10s audio) {#tbl-trt-benchmark}
...
: ONNX Runtime Quantization results {#tbl-ort-quantization}
...
: Whisper variants comparison {#tbl-whisper-variants}
...
: OpenVINO speedup trên Intel Xeon (batch=1) {#tbl-openvino-benchmark}
...
: Production Speech Pipeline components {#tbl-pipeline-components}
...
::: {.callout-warning title="GPU Memory Budget"}
...
: Inference Engine Recommendations {#tbl-engine-recommendations}
