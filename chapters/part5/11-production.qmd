---
title: "Production Speech Systems"
---

## 11.1 End-to-End Voice AI Pipeline
...
: Latency budget breakdown {#tbl-latency-budget}
...
## 11.2 Voice Activity Detection (VAD)
...
: Silero VAD specifications {#tbl-silero-vad}
...
: Streaming vs offline ASR {#tbl-streaming-vs-offline}

### 11.3.2 Chunked Streaming
...
: Streaming ASR latency-accuracy trade-off {#tbl-streaming-tradeoff}
...
Strategy 1: VAD-based
    Silence > threshold → end of utterance
...
: Quantization trade-offs {#tbl-quantization}
...
: Batching strategies {#tbl-batching}
...
## 11.6 TensorRT-LLM & Triton Inference Server

### 11.6.1 TensorRT-LLM cho Whisper
...
### 11.6.2 Performance with TensorRT-LLM
...
: TensorRT-LLM Whisper performance {#tbl-trt-whisper}

## 11.7 Production Architecture

### 11.7.1 Microservice Architecture
...
: GPU resource planning {#tbl-gpu-planning}

::: {.callout-note title="Cost Optimization"}
...
: Production monitoring metrics {#tbl-monitoring}
