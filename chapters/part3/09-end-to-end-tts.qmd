...
![Tiến hóa của TTS: từ Two-Stage đến End-to-End](fig-09-end-to-end-tts-08.png){#fig-tts-evolution width=75%}
...
![Kiến trúc VITS: VAE + Normalizing Flow + GAN (Training)](fig-09-end-to-end-tts-09.png){#fig-vits-arch width=50%}
...
![Kiến trúc VALL-E: AR (codebook 1) + NAR (codebooks 2-8)](fig-09-end-to-end-tts-10.png){#fig-valle-arch width=50%}
...
![F5-TTS: DiT Block architecture](fig-09-end-to-end-tts-11.png){#fig-f5tts-dit width=60%}
