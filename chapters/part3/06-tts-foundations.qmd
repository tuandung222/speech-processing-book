---
title: "TTS Foundations & Vocoders"
---

## 6.1 Bài toán Text-to-Speech
...
Text → [Acoustic Model] → Mel Spectrogram → [Vocoder] → Waveform
                                   │
      Stage 1: Text-to-Mel         │         Stage 2: Mel-to-Wave
      (Tacotron 2, FastSpeech 2)   │         (HiFi-GAN, WaveNet)
```
...
### 6.2.2 Location-Sensitive Attention
...
: Tacotron 2 limitations {#tbl-tacotron-limits}

## 6.3 FastSpeech 2

### 6.3.1 Key Innovation: Non-Autoregressive
...
└──────┬───────┘
       ...
       ├──→ Pitch Predictor → predicted pitch f0
...
: FastSpeech 2 vs Tacotron 2 speed {#tbl-fastspeech-speed}
...
: Vocoder comparison {#tbl-vocoder-comparison}
...
: TTS pipeline summary {#tbl-tts-summary}
