...
![Two-Stage TTS Pipeline](fig-08-tts-foundations-05.png){#fig-tts-pipeline width=75%}
...
![Kiến trúc Tacotron 2](fig-08-tts-foundations-06.png){#fig-tacotron2-arch width=60%}
...
![Kiến trúc FastSpeech 2: Non-Autoregressive TTS](fig-08-tts-foundations-07.png){#fig-fastspeech2-arch width=50%}
