...
## 8.1 Tại sao cần Neural Audio Codecs?
...
## 8.3 Residual Vector Quantization (RVQ)
...
Waveform (24kHz)
    ...
    ▼
┌────────────────────┐
│ Encoder             │  4 conv blocks (stride 2,4,5,8)
│ (1D CNN)            │  Total stride: 320
│                     │  24kHz / 320 = 75 fps
└────────┬───────────┘
         │  [B, 128, T/320]
         ▼
┌────────────────────┐
│ RVQ                 │  8 codebooks × 1024 entries
│ (8 layers)          │  Bitrate: 6 kbps
└────────┬───────────┘
         │  [B, 8, T/320] (integer tokens)
         ▼
┌────────────────────┐
│ Decoder             │  4 transposed conv blocks
│ (1D CNN)            │  Mirror of encoder
└────────┬───────────┘
         │
         ▼
...
### 8.6.1 Disentangled Semantic/Acoustic Tokens
...
## 8.7 Mimi — Ultra-Low Latency Codec

### 8.7.1 Key Innovation
...
### 8.7.3 Tại sao 12.5 Hz quan trọng?
