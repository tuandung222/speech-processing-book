---
title: "Vietnamese Datasets & Ecosystem"
---
...
::: {.callout-note title="Thách thức riêng của Tiếng Việt"}
...
: Vietnamese TTS Datasets {#tbl-vi-tts-datasets}
...
::: {.callout-warning title="So sánh với English"}
...
: VLSP Competition Results {#tbl-vlsp-benchmarks}
...
: International Benchmarks có Vietnamese {#tbl-international-benchmarks-vi}
...
: Vietnamese ASR Models {#tbl-vi-asr-models}
...
: Voice Conversion approaches {#tbl-vc-approaches}
...
: Hệ sinh thái Speech AI tại Việt Nam {#tbl-vi-ecosystem}
