...
::: {.callout-note title="Định lý Nyquist-Shannon"}
...
: Thông số chuẩn cho speech audio {#tbl-audio-params}
...
::: {.callout-note title="Ý nghĩa Vật lý"}
...
::: {.callout-note title="Ý nghĩa Trực giác"}
...
: Mel Spectrogram vs MFCC {#tbl-mel-vs-mfcc}
...
: Tóm tắt các phép biến đổi audio {#tbl-audio-summary}
