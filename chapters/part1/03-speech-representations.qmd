---
title: "Speech Pretraining & Representation Learning"
---
...
::: {.callout-note title="HuBERT vs Wav2Vec 2.0"}
| | Wav2Vec 2.0 | HuBERT |
|---|---|---|
...
: So sánh các mô hình speech representation {#tbl-ssl-comparison}
...
: SUPERB benchmark tasks {#tbl-superb-tasks}
