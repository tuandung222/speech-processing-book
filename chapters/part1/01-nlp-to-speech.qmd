---
title: "From NLP to Speech  -  The Conceptual Bridge"
---
...
: So sánh Text vs Audio {#tbl-text-vs-audio}

::: {.callout-note title="Core Insight"}
...
::: {.callout-tip title="NLP Parallel: BPE vs Neural Codecs"}
...
![Phân loại các mô hình Speech AI](fig-01-nlp-to-speech-01.png){#fig-speech-taxonomy width=40%}
...
: NLP↔Speech concept mapping {#tbl-nlp-speech-mapping}
...
: So sánh kích thước dữ liệu Text vs Audio {#tbl-data-scale}
...
4. **Mọi khái niệm NLP** đều có speech equivalent  -  @tbl-nlp-speech-mapping là tham chiếu chính
