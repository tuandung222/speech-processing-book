...
::: {.callout-note title="Bước tiến từ Transformer đến Conformer"}
...
: Conformer vs Transformer trên LibriSpeech {#tbl-conformer-results}
...
::: {.callout-note title="Tại sao E-Branchformer?"}
...
: So sánh kiến trúc ASR hiện đại {#tbl-modern-asr-comparison}
...
: Attention vs Mamba vs Hybrid cho speech {#tbl-hybrid-ssm-speech}

::: {.callout-warning title="SSM cho Speech còn rất mới"}
...
: Tổng hợp kiến trúc ASR hiện đại {#tbl-asr-summary}
