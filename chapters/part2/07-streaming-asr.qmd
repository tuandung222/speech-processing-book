...
::: {.callout-note title="Offline vs Streaming ASR"}
...
: So sánh Offline vs Streaming ASR {#tbl-offline-vs-streaming}
...
::: {.callout-warning title="Latency Target"}
...
: So sánh các Streaming ASR engines {#tbl-streaming-asr-engines}
...
: Metrics cho Streaming ASR {#tbl-streaming-metrics}
