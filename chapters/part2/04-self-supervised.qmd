...
## 4.1 Motivation: BERT for Speech
...
Raw Waveform [1, T_samples]
       ...
       ▼
┌─────────────────┐
│ CNN Feature      │  7 conv layers, stride 5×2×2×2×2×2×2 = 320
│ Encoder          │  Downsampling: 16kHz → 50 fps
└────────┬────────┘
         │  z_t: [batch, T', 512]
         ▼
    ┌────┴────────────────┐
...
### 4.3.4 So sánh Wav2Vec 2.0 vs HuBERT
