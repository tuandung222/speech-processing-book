...
![3 cấp độ tích hợp Speech vào LLM](fig-11-speech-llms-14.png){#fig-speech-llm-levels width=50%}
...
![AudioLM: Hierarchical Token Structure](fig-11-speech-llms-15.png){#fig-audiolm-hierarchy width=70%}
...
![Kiến trúc Qwen2-Audio: Whisper Encoder + Adapter + LLM](fig-11-speech-llms-16.png){#fig-qwen2audio-arch width=60%}
...
![Half-Duplex vs Full-Duplex Speech](fig-11-speech-llms-17.png){#fig-half-vs-full-duplex width=75%}

### Architecture

Moshi [@defossez2024moshi] xử lý **2 audio streams song song** (user + AI):

![Kiến trúc Moshi: Dual-stream full-duplex speech](fig-11-speech-llms-18.png){#fig-moshi-arch width=60%}
...
![Moshi: Temporal + Depth Transformer](fig-11-speech-llms-19.png){#fig-depth-temporal width=60%}
...
![GPT-4o Voice (suy đoán): Unified Multimodal Transformer](fig-11-speech-llms-20.png){#fig-gpt4o-arch width=60%}
