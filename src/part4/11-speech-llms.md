...
<figure id="fig-speech-llm-levels">
  <img src="fig-11-speech-llms-14.png" alt="3 cấp độ tích hợp Speech vào LLM" />
  <figcaption><strong>Hình:</strong> 3 cấp độ tích hợp Speech vào LLM</figcaption>
</figure>
...
<figure id="fig-audiolm-hierarchy">
  <img src="fig-11-speech-llms-15.png" alt="AudioLM: Hierarchical Token Structure" />
  <figcaption><strong>Hình:</strong> AudioLM: Hierarchical Token Structure</figcaption>
</figure>
...
<figure id="fig-qwen2audio-arch">
  <img src="fig-11-speech-llms-16.png" alt="Kiến trúc Qwen2-Audio: Whisper Encoder + Adapter + LLM" />
  <figcaption><strong>Hình:</strong> Kiến trúc Qwen2-Audio: Whisper Encoder + Adapter + LLM</figcaption>
</figure>
...
<figure id="fig-half-vs-full-duplex">
  <img src="fig-11-speech-llms-17.png" alt="Half-Duplex vs Full-Duplex Speech" />
  <figcaption><strong>Hình:</strong> Half-Duplex vs Full-Duplex Speech</figcaption>
</figure>
...
<figure id="fig-moshi-arch">
  <img src="fig-11-speech-llms-18.png" alt="Kiến trúc Moshi: Dual-stream full-duplex speech" />
  <figcaption><strong>Hình:</strong> Kiến trúc Moshi: Dual-stream full-duplex speech</figcaption>
</figure>
...
<figure id="fig-depth-temporal">
  <img src="fig-11-speech-llms-19.png" alt="Moshi: Temporal + Depth Transformer" />
  <figcaption><strong>Hình:</strong> Moshi: Temporal + Depth Transformer</figcaption>
</figure>
