...
<figure markdown id="fig-rnnt-lattice">
  ![RNN-T Lattice: → = emit label (advance u), ↓ = emit blank (advance t)](fig-04-asr-foundations-02.png)
  <figcaption>RNN-T Lattice: → = emit label (advance u), ↓ = emit blank (advance t)</figcaption>
</figure>
