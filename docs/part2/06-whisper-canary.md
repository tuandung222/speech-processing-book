...
<figure markdown id="fig-whisper-arch">
  ![Kiến trúc Whisper: Encoder-Decoder Transformer cho Multitask Speech](fig-06-whisper-canary-04.png)
  <figcaption>Kiến trúc Whisper: Encoder-Decoder Transformer cho Multitask Speech</figcaption>
</figure>
...
!!! note "Multitask = Prompt Engineering for ASR"
...
: Whisper Vietnamese performance <a id="tbl-whisper-vi"></a>

!!! note "Vietnamese Challenges"
