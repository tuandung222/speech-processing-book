...
<figure markdown id="fig-endpointing">
  ![3 Endpointing Strategies](fig-20-production-23.png)
  <figcaption>3 Endpointing Strategies</figcaption>
</figure>
...
<figure markdown id="fig-tensorrt-triton">
  ![TensorRT-LLM + Triton Inference Server Pipeline](fig-20-production-24.png)
  <figcaption>TensorRT-LLM + Triton Inference Server Pipeline</figcaption>
</figure>
...
<figure markdown id="fig-microservice-arch">
  ![Production Microservice Architecture](fig-20-production-25.png)
  <figcaption>Production Microservice Architecture</figcaption>
</figure>
