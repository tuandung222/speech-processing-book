...
<figure markdown id="fig-vi-tts-pipeline">
  ![Vietnamese Text Processing Pipeline cho TTS](fig-16-vietnamese-speech-21.png)
  <figcaption>Vietnamese Text Processing Pipeline cho TTS</figcaption>
</figure>
