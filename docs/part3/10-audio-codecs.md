...
<figure markdown id="fig-encodec-arch">
  ![Kiến trúc EnCodec: Encoder → RVQ → Decoder](fig-10-audio-codecs-12.png)
  <figcaption>Kiến trúc EnCodec: Encoder → RVQ → Decoder</figcaption>
</figure>
...
<figure markdown id="fig-speechtokenizer">
  ![SpeechTokenizer: Disentangled Semantic/Acoustic Tokens](fig-10-audio-codecs-13.png)
  <figcaption>SpeechTokenizer: Disentangled Semantic/Acoustic Tokens</figcaption>
</figure>
