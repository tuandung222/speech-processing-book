...
<figure markdown id="fig-tts-evolution">
  ![Tiến hóa của TTS: từ Two-Stage đến End-to-End](fig-09-end-to-end-tts-08.png)
  <figcaption>Tiến hóa của TTS: từ Two-Stage đến End-to-End</figcaption>
</figure>
...
<figure markdown id="fig-vits-arch">
  ![Kiến trúc VITS: VAE + Normalizing Flow + GAN (Training)](fig-09-end-to-end-tts-09.png)
  <figcaption>Kiến trúc VITS: VAE + Normalizing Flow + GAN (Training)</figcaption>
</figure>
...
<figure markdown id="fig-valle-arch">
  ![Kiến trúc VALL-E: AR (codebook 1) + NAR (codebooks 2-8)](fig-09-end-to-end-tts-10.png)
  <figcaption>Kiến trúc VALL-E: AR (codebook 1) + NAR (codebooks 2-8)</figcaption>
</figure>
...
<figure markdown id="fig-f5tts-dit">
  ![F5-TTS: DiT Block architecture](fig-09-end-to-end-tts-11.png)
  <figcaption>F5-TTS: DiT Block architecture</figcaption>
</figure>
